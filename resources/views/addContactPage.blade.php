                ...
                <div class="container border border-secondary mr-2 my-2 p-3 thick-border-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <label class="cursor-pointer">
                                <input class="readable" type="radio" name="contact_civilite" value="madame" checked>
                                <i class="madame fas fa-female border rounded p-2"><p class="d-inline ml-2">Madame</p></i>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label>
                                <input class="readable" type="radio" name="contact_civilite" value="monsieur">
                    ...
                    <div class="row d-flex justify-content-start">
                        <div class="col form-group">
                            ...
                            <input class="form-control readable" id="contact_prenom" name="contact_prenom" type="text" value="" >
                            <div class="invalid-feedback contact_prenom_feedback"></div>
                        </div>
                        <div class="col form-group">
                            <label class="font-weight-bold" for="contact_nom">Nom</label>
                            <input class="form-control readable" id="contact_nom" name="contact_nom" type="text" value="" >
                    ...
                    <div class="row d-flex justify-content-start">
                        <div class="col form-group">
                            ...
                            <input class="form-control readable" id="contact_fonction" name="contact_fonction" type="text" value="" >
                            <div class="invalid-feedback contact_fonction_feedback"></div>
                        </div>
                        <div class="col form-group">
                            <label class="font-weight-bold" for="contact_service">Service</label>
                            <input class="form-control readable" id="contact_service" name="contact_service" type="text" value="" >
                    ...
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input class="form-control readable" id="contact_e_mail" name="contact_e_mail" type="text" value="" >
                    ...
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input class="form-control readable" id="contact_telephone" name="contact_telephone" type="text" value="" >
                        ...
                        <div class="col form-group">
                            ...
                            <input class="form-control readable" id="contact_date_naissance" name="contact_date_naissance" type="text" value="" >
